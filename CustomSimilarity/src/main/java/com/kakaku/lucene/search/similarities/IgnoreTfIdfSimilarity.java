package com.kakaku.lucene.search.similarities;
 ...
 */
public class IgnoreTfIdfSimilarity extends TFIDFSimilarity {
  ...
  /** 
   * If flag is true, set TF or IDF to a fixed value "1f"
   * discounted from the document's length.
   */
  protected boolean ignoreTfFlg = false;
  protected boolean ignoreIdfFlg = false;
    
  public void setIgnoreTfFlg(boolean v) {
    ignoreTfFlg = v;
  }

  public void setIgnoreIdfFlg(boolean v) {
    ignoreIdfFlg = v;
  }

  public boolean getIgnoreTfFlg() {
    return ignoreTfFlg;
  }

  public boolean getIgnoreIdfFlg() {
    return ignoreTfFlg;
  }
